  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        dropdown: cn(
          "absolute bg-[var(--panel-strong)] inset-0 opacity-0",
          defaults.dropdown,
        ),
        caption_label: cn(
        ...
        range_start: cn("rounded-l-md bg-blue-500/30", defaults.range_start),
  ...
  return (
    <Button
      ...
      className={cn(
        ...
        "data-[range-middle=true]:bg-blue-500/20 data-[range-middle=true]:text-blue-300",
